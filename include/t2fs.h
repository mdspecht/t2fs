...
typedef unsigned short int WORD; //A 16-bit unsigned integer. The range is 0 through 65535 decimal.
typedef unsigned int DWORD; //A 32-bit unsigned integer. The range is 0 through 4294967295 decimal.
